...
const RULES: Rule[] = [
  ...
  { kind: 'optional-string', name: 'SENTRY_DSN',         fallback: '' },
  { kind: 'optional-string', name: 'ENABLE_API_DOCS',    fallback: '' },
...
export const env = {
  ...
  SENTRY_DSN:             validated.SENTRY_DSN             as string,
  ENABLE_API_DOCS:        validated.ENABLE_API_DOCS        as string,
